                ...
                <div class="caja-formulario">
                    ...
                    <form action="index.php?action=procesarPago" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="tel" name="telefono_envio" pattern="[0-9+ ]{9,15}"
                                   class="form-control"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text"
                                ...
                                name="cardNumber"
                                class="form-control"
                                placeholder="4242 4242 4242 4242" pattern="[0-9 ]{16,19}" maxlength="19"
                                required>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text"
                                    ...
                                    name="cvv"
                                    class="form-control"
                                    placeholder="123" pattern="[0-9]{3}" maxlength="3"
                                    required>
