    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-md-6 text-white">
                <h1 class="titulo-formulario">PANEL <br><span>ADMIN</span></h1>
            </div>
                ...
                <div class="caja-formulario">
                    ...
                    <form action="index.php?action=guardarProducto" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" name="imagen" class="form-control" accept="image/png,image/jpeg,image/webp" required>
                        </div>

                        <button class="btn btn-primary w-100 mt-2">GUARDAR PRODUCTO</button>
                    </form>
                </div>
            </div>
        </div>
